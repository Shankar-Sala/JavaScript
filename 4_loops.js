...
// var userAge = 18;
// var isCitizen = false; // Assume true for citizen, false for non-citizen
...
//     break;
//     case "Friday": console.log("omg let's have party today");
//     break;
//     case "Sunday": console.log("let's go to movie");
//     break;
...
//     default: console.log("no shape matches");
// }
...
// ! Question: How does the switch statement handle the flow of control based on the value od areaOfShapes?
// ? The switch statement evaluates the values of areaOfShapes and executes the code block corresponding to the matching case. The break statement ensure that only the relevant code block is executed.
