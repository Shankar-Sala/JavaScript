...
//! Write a JavaScript program that defines a function called greet to welcome individuals to the  JS Course. The function should take a name parameter and output the message "Hello [name], Welcome to  JS Course". Call the function twice, once with the argument "shankar" and once with the argument "ram".
...
// console.log(isReverse("Shankar Sala"));


// let str = "shankar sala";
// console.log(str[2]);
